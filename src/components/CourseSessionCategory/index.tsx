      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="mb-6 flex items-center justify-between md:mb-8">
          <div className="flex items-center gap-4">
            <svg width="128" height="128" viewBox="0 0 128 128" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-12 h-12 md:w-16 md:h-16">
              <path d="M11.6125 101.334H116.56C116.56 103.271 114.99 104.841 113.053 104.841H15.1191C13.1825 104.841 11.6125 103.271 11.6125 101.334Z" fill="black"/>
              <rect x="8.54639" y="96.2018" width="110.907" height="5.50659" rx="2.7533" fill="white" stroke="black" stroke-width="2"/>
              <rect x="12.2146" y="25.1449" width="21.3184" height="69.841" rx="5" fill="white" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              <rect x="33.9102" y="25.1449" width="21.3184" height="69.841" rx="5" fill="white" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              <ellipse cx="22.8047" cy="65.9198" rx="4.04636" ry="5.8543" stroke="black" stroke-width="2"/>
              <ellipse cx="44.5693" cy="65.9198" rx="4.04636" ry="5.8543" stroke="black" stroke-width="2"/>
              <path d="M12.6458 38.4561H32.7914" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M12.6455 42.933H32.7912" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M34.4963 38.4561H54.642" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M34.4966 42.933H54.6423" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              <rect x="55.6052" y="25.145" width="21.3184" height="69.841" rx="5" fill="white" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              <ellipse cx="66.2644" cy="65.9198" rx="4.04636" ry="5.8543" stroke="black" stroke-width="2"/>
              <path d="M55.7783 38.4563H75.924" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M55.7776 42.9332H75.9233" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              <rect x="75.4763" y="28.8634" width="22.0397" height="70.5529" rx="5" transform="rotate(-15 75.4763 28.8634)" fill="black"/>
              <ellipse cx="96.7696" cy="65.7188" rx="4.04636" ry="5.8543" transform="rotate(-15 96.7696 65.7188)" fill="black" stroke="white" stroke-width="2"/>
              <path d="M80.8374 41.5554L98.3262 36.8693" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M81.9963 45.8796L99.4851 41.1935" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
            <h2 className="text-lg font-bold text-gray-800 md:text-2xl md:text-white">دسته بندی دوره ها</h2>
          </div>
