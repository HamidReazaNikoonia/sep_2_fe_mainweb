...
import { getAllProgramsRequest } from '@/API/courseSession';
...
export const useClassProgramInfinite = (filters: CourseFilters) => {
  return useInfiniteQuery({
    ...
    queryFn: async ({ pageParam = 1 }) => {
      ...
      const response = await getAllProgramsRequest(cleanParams);
